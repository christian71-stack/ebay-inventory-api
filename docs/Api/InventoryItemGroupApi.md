...
> \Ebay\Sell\Inventory\Model\BaseResponse createOrReplaceInventoryItemGroup($body, $content_language, $content_type, $inventory_item_group_key)
...
> \Ebay\Sell\Inventory\Model\InventoryItemGroup getInventoryItemGroup($inventory_item_group_key)
