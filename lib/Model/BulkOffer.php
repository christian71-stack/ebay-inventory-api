...
class BulkOffer implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'requests' => '\Ebay\Sell\Inventory\Model\OfferKeyWithId[]'
    ];
     ...
     * Sets requests
     *
     * @param \Ebay\Sell\Inventory\Model\OfferKeyWithId[] $requests This container is used to pass in an array of offers to publish. Up to 25 offers can be published with one <strong>bulkPublishOffer</strong> method.
     *
     * @return $this
     */
