...
class ShipToLocationAvailabilityWithAll implements ModelInterface, ArrayAccess
{
     ...
     *
     * @return \Ebay\Sell\Inventory\Model\FormatAllocation
     */
     ...
     *
     * @param \Ebay\Sell\Inventory\Model\FormatAllocation $allocation_by_format allocation_by_format
     *
     * @return $this
     */
     ...
     *
     * @return \Ebay\Sell\Inventory\Model\AvailabilityDistribution[]
     */
     ...
     *
     * @param \Ebay\Sell\Inventory\Model\AvailabilityDistribution[] $availability_distributions This container is used to set the available quantity of the inventory item at one or more warehouse locations.<br><br> This container will be returned if the available quantity is set for one or more inventory locations.
     *
     * @return $this
     */
