...
class BulkPriceQuantity implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'requests' => '\Ebay\Sell\Inventory\Model\PriceQuantity[]'
    ];
     ...
     * Gets requests
     *
     * @return \Ebay\Sell\Inventory\Model\PriceQuantity[]
     */
     ...
     * Sets requests
     *
     * @param \Ebay\Sell\Inventory\Model\PriceQuantity[] $requests This container is used by the seller to update the total 'ship-to-home' quantity of one or more inventory items (up to 25) and/or to update the price and/or quantity of one or more specific published offers.
     *
     * @return $this
     */
