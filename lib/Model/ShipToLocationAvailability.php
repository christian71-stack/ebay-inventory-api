...
class ShipToLocationAvailability implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param \Ebay\Sell\Inventory\Model\AvailabilityDistribution[] $availability_distributions This container is used to set the available quantity of the inventory item at one or more warehouse locations.<br><br> This container will be returned if available quantity is set for one or more inventory locations.
     *
     * @return $this
     */
