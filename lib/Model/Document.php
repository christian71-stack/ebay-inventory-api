...
class Document implements ModelInterface, ArrayAccess
{
     ...
     * Sets document_id
     *
     * @param string $document_id The unique identifier of a regulatory document associated with the listing.<br><br>This value can be found in the response of the <a href=\"/api-docs/commerce/media/resources/document/methods/createDocument\" target=\"_blank\">createDocument</a> method of the Media API.
     *
     * @return $this
     */
