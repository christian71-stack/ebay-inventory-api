...
class Manufacturer implements ModelInterface, ArrayAccess
{
     ...
     * Sets address_line1
     *
     * @param string $address_line1 The first line of the product manufacturer's street address.<br><br><b>Max length</b>: 180 characters
     *
     * @return $this
     */
     ...
     * Sets address_line2
     *
     * @param string $address_line2 The second line of the product manufacturer's street address. This field is not always used, but can be used for secondary address information such as 'Suite Number' or 'Apt Number'.<br><br><b>Max length</b>: 180 characters
     *
     * @return $this
     */
     ...
     * Sets city
     *
     * @param string $city The city of the product manufacturer's street address.<br><br><b>Max length</b>: 64 characters
     *
     * @return $this
     */
     ...
     * Sets company_name
     *
     * @param string $company_name The company name of the the product manufacturer.<br><br><b>Max length</b>: 100 characters
     *
     * @return $this
     */
     ...
     * Sets email
     *
     * @param string $email The product manufacturer's business email address.<br><br><b>Max length</b>: 180 characters
     *
     * @return $this
     */
     ...
     * Sets phone
     *
     * @param string $phone The product manufacturer's business phone number.<br><br><b>Max length</b>: 64 characters
     *
     * @return $this
     */
     ...
     * Sets postal_code
     *
     * @param string $postal_code The postal code of the product manufacturer's street address.<br><br><b>Max length</b>: 9 characters
     *
     * @return $this
     */
     ...
     *
     * @param string $state_or_province The state or province of the product manufacturer's street address.<br><br><b>Max length</b>: 64 characters
     *
     * @return $this
     */
