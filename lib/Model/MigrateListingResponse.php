...
class MigrateListingResponse implements ModelInterface, ArrayAccess
{
     ...
     * Gets errors
     *
     * @return \Ebay\Sell\Inventory\Model\Error[]
     */
     ...
     * Sets errors
     *
     * @param \Ebay\Sell\Inventory\Model\Error[] $errors If one or more errors occur with the attempt to migrate the listing, this container will be returned with detailed information on each error.
     *
     * @return $this
     */
     ...
     *
     * @return \Ebay\Sell\Inventory\Model\InventoryItemListing[]
     */
     ...
     * Sets marketplace_id
     *
     * @param string $marketplace_id This is the unique identifier of the eBay Marketplace where the listing resides. The value fo the eBay US site will be <code>EBAY_US</code>. For implementation help, refer to <a href='https://developer.ebay.com/api-docs/sell/inventory/types/slr:MarketplaceEnum'>eBay API documentation</a>
     *
     * @return $this
     */
     ...
     * Sets warnings
     *
     * @param \Ebay\Sell\Inventory\Model\Error[] $warnings If one or more warnings occur with the attempt to migrate the listing, this container will be returned with detailed information on each warning. It is possible that a listing can be successfully migrated even if a warning occurs.
     *
     * @return $this
     */
