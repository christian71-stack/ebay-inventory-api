...
class Compatibility implements ModelInterface, ArrayAccess
{
     ...
     *
     * @return \Ebay\Sell\Inventory\Model\CompatibleProduct[]
     */
     ...
     *
     * @param \Ebay\Sell\Inventory\Model\CompatibleProduct[] $compatible_products This container consists of an array of motor vehicles (make, model, year, trim, engine) that are compatible with the motor vehicle part or accessory specified by the sku value.
     *
     * @return $this
     */
