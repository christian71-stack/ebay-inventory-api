...
class InventoryItemResponse implements ModelInterface, ArrayAccess
{
     ...
     * Sets errors
     *
     * @param \Ebay\Sell\Inventory\Model\Error[] $errors This container will be returned if there were one or more errors associated with the creation or update to the inventory item record.
     *
     * @return $this
     */
     ...
     * Sets warnings
     *
     * @param \Ebay\Sell\Inventory\Model\Error[] $warnings This container will be returned if there were one or more warnings associated with the creation or update to the inventory item record.
     *
     * @return $this
     */
