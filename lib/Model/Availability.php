...
class Availability implements ModelInterface, ArrayAccess
{
     ...
     *
     * @return \Ebay\Sell\Inventory\Model\PickupAtLocationAvailability[]
     */
    public function getPickupAtLocationAvailability(): array
    {
