...
class InventoryLocationResponse implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param \Ebay\Sell\Inventory\Model\OperatingHours[] $operating_hours This container shows the regular operating hours for a store location during the days of the week. A <strong>dayOfWeekEnum</strong> field and an <strong>intervals</strong> container is shown for each day of the week that the store location is open.
     *
     * @return $this
     */
     ...
     * Sets special_hours
     *
     * @param \Ebay\Sell\Inventory\Model\SpecialHours[] $special_hours This container shows the special operating hours for a store location on a specific date or dates.
     *
     * @return $this
     */
