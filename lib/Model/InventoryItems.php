...
class InventoryItems implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'href' => 'string',
        'inventory_items' => '\Ebay\Sell\Inventory\Model\InventoryItemWithSkuLocaleGroupid[]',
        'limit' => 'int',
        'next' => 'string',
        'prev' => 'string',
        'size' => 'int',
     ...
     *
     * @param \Ebay\Sell\Inventory\Model\InventoryItemWithSkuLocaleGroupid[] $inventory_items This container is an array of one or more inventory items, with detailed information on each inventory item.
     *
     * @return $this
     */
