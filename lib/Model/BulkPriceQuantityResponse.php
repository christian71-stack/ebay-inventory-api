...
class BulkPriceQuantityResponse implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'responses' => '\Ebay\Sell\Inventory\Model\PriceQuantityResponse[]'
    ];
     ...
     * Gets responses
     *
     * @return \Ebay\Sell\Inventory\Model\PriceQuantityResponse[]
     */
     ...
     * Sets responses
     *
     * @param \Ebay\Sell\Inventory\Model\PriceQuantityResponse[] $responses This container will return an HTTP status code, offer ID, and SKU value for each offer/inventory item being updated, as well as an <strong>errors</strong> and/or <strong>warnings</strong> container if any errors or warnings are triggered while trying to update those offers/inventory items.
     *
     * @return $this
     */
