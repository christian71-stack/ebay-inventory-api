...
class PublishResponse implements ModelInterface, ArrayAccess
{
     ...
     * Sets warnings
     *
     * @param \Ebay\Sell\Inventory\Model\Error[] $warnings This container will contain an array of errors and/or warnings if any occur when a <strong>publishOffer</strong> or <strong>publishOfferByInventoryItemGroup</strong> call is made.
     *
     * @return $this
     */
