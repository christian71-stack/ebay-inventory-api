...
class InventoryItemWithSkuLocale implements ModelInterface, ArrayAccess
{
     ...
     * Gets availability
     *
     * @return \Ebay\Sell\Inventory\Model\Availability
     */
     ...
     * Sets availability
     *
     * @param \Ebay\Sell\Inventory\Model\Availability $availability availability
     *
     * @return $this
     */
     ...
     * Sets locale
     *
     * @param string $locale This request parameter sets the natural language that was provided in the field values of the request payload (i.e., en_AU, en_GB or de_DE). For implementation help, refer to <a href='https://developer.ebay.com/api-docs/sell/inventory/types/slr:LocaleEnum'>eBay API documentation</a>
     *
     * @return $this
     */
